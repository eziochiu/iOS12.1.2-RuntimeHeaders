...
- (void)purchaseWithBuyParameters:(void *)arg1 storeID:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 10: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, BLPurchaseResponse *, NSError *, void*
