...
- (void)presentRegistrationFlowWithAccount:(void *)arg1 amount:(void *)arg2 state:(void *)arg3 senderAddress:(void *)arg4 orientation:(void *)arg5 completion:(void *)arg6; // needs 6 arg types, found 11: PKPeerPaymentAccount *, PKCurrencyAmount *, unsigned long long, NSString *, NSNumber *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
- (void)receivedPeerPaymentMessageData:(void *)arg1 handler:(void *)arg2; // needs 2 arg types, found 6: NSData *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
