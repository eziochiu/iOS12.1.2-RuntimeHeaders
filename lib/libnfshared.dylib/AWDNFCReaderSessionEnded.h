...
@property (nonatomic) unsigned int exitReason;
...
@property (nonatomic) unsigned int tagsRead;
...
- (void)setExitReason:(unsigned int)arg1;
...
- (void)setTagsRead:(unsigned int)arg1;
- (void)setTimeDeltaFromReference:(unsigned long long)arg1;
- (void)setTimestamp:(unsigned long long)arg1;
- (void)setType:(unsigned int)arg1;
- (void)setUuidReference:(id)arg1;
- (unsigned int)tagsRead;
