...
@interface MattingRGBDFilter : NSObject <MattingFilter> {
    ...
    <MTLComputePipelineState> * _applyDepthAwareCoefficientsKernel;
    <MTLComputePipelineState> * _applyDepthAwareCoefficientsSamplingKernel;
    <MTLComputePipelineState> * _applyDepthAwareCoefficientsSamplingNoConstraintsKernel;
    NSArray * _coefficients;
    NSArray * _coefficientsTexture2DView;
    <MTLComputePipelineState> * _compute4DCoefficientsKernel;
    <MTLComputePipelineState> * _computeInverted4DGuideCovarianceMatrixKernel;
    <MTLTexture> * _constraints;
    <MTLTexture> * _constraintsTexture2DView;
    <MTLDevice> * _device;
    <MTLTexture> * _guideStack;
    <MTLTexture> * _guideStackTexture2DView;
    <MTLComputePipelineState> * _halfToAlphaBLKernel;
    <MTLLibrary> * _library;
    <MTLTexture> * _mean_I;
