...
@property (nonatomic, retain) PUAlbumDropSessionController *dropSessionController;
...
@property (nonatomic) PUPhotosPickerViewController *photosPickerViewController;
...
@property (nonatomic, retain) PXPhotosGlobalFooterView *syncProgressView;
...
- (void)_dismissPhotosPickerControllerAnimated:(bool)arg1 completion:(id /* block */)arg2;
- (id)_doneButtonItem;
...
- (void)_navigateToPeopleAnimated:(bool)arg1 withPersonLocalIdentifier:(id)arg2 withCompletion:(id /* block */)arg3;
...
- (void)setDropSessionController:(id)arg1;
- (void)setEditing:(bool)arg1 animated:(bool)arg2;
- (void)setKeyboardAware:(bool)arg1;
- (void)setPhotosPickerViewController:(id)arg1;
