...
- (void)animatePropertyWithCurrentValue:(id)arg1 targetValue:(id)arg2 preTickShouldRemoveCallback:(id /* block */)arg3 newValueCallback:(id /* block */)arg4 removedCallback:(id /* block */)arg5 animatablePropertyState:(id)arg6;
