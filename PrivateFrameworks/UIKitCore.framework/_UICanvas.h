...
@property (getter=_screenRequestedDisplayPixelSize, setter=_setScreenRequestedDisplayPixelSize:, nonatomic) struct CGSize { double x1; double x2; } screenRequestedDisplayPixelSize;
...
- (struct CGSize { double x1; double x2; })_screenRequestedDisplayPixelSize;
- (long long)_screenRequestedOverscanCompensation;
...
- (void)_setScreenRequestedDisplayPixelSize:(struct CGSize { double x1; double x2; })arg1;
