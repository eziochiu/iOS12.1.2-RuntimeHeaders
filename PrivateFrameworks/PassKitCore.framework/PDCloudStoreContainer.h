...
- (void)fetchAndStoreChangesWithForceFetch:(bool)arg1 operationGroupName:(id)arg2 operationGroupNameSuffix:(id)arg3 completion:(id /* block */)arg4;
- (void)fetchAndStoreChangesWithForceFetch:(bool)arg1 operationGroupName:(id)arg2 operationGroupNameSuffix:(id)arg3 userInfo:(id)arg4 completion:(id /* block */)arg5;
- (void)fetchAndStoreChangesWithOperationGroupName:(id)arg1 operationGroupNameSuffix:(id)arg2 completion:(id /* block */)arg3;
...
- (void)processFetchedCloudStoreDataWithModifiedRecords:(id)arg1 deletedRecords:(id)arg2 operationGroupName:(id)arg3 operationGroupNameSuffix:(id)arg4 shouldUpdateLocalDatabase:(bool)arg5 completion:(id /* block */)arg6;
