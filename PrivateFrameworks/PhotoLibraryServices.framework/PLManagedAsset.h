...
@interface PLManagedAsset : PLManagedObject <PLCloudDeletable, PLMomentAssetData_Private, PLPTPTransferableAsset, PLSyncableAsset, UIActivityItemSource, _PLImageLoadingAsset> {
...
+ (id)entityName;
+ (void)enumerateImageRequestHintData:(id)arg1 assetWidth:(long long)arg2 assetHeight:(long long)arg3 block:(id /* block */)arg4;
+ (id)eventInfoForPTP;
...
- (void)enumerateImageRequestHints:(id /* block */)arg1;
