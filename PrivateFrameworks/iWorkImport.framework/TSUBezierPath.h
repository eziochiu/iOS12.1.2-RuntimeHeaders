...
+ (id)createClippedPath:(id)arg1 headPositioning:(struct { double x1; struct CGPoint { double x_2_1_1; double x_2_1_2; } x2; long long x3; double x4; })arg2 tailPositioning:(struct { double x1; struct CGPoint { double x_2_1_1; double x_2_1_2; } x2; long long x3; double x4; })arg3 stroke:(id)arg4;
...
+ (struct { double x1; struct CGPoint { double x_2_1_1; double x_2_1_2; } x2; long long x3; double x4; })lineEndPositioningOnPath:(id)arg1 atHead:(bool)arg2 headPoint:(struct CGPoint { double x1; double x2; })arg3 tailPoint:(struct CGPoint { double x1; double x2; })arg4 headLineEnd:(id)arg5 tailLineEnd:(id)arg6 stroke:(id)arg7;
+ (unsigned long long)lineJoinStyle;
+ (double)lineWidth;
+ (struct { double x1; struct CGPoint { double x_2_1_1; double x_2_1_2; } x2; long long x3; double x4; })makeDefaultPositioning;
+ (double)miterLimit;
...
- (struct CGPoint { double x1; double x2; })myGradientAt:(double)arg1;
- (struct CGPoint { double x1; double x2; })myGradientAt:(double)arg1 fromElement:(long long)arg2;
