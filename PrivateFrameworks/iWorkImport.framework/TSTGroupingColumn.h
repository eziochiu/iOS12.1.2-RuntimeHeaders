...
- (void)encodeToArchive:(struct GroupColumnArchive { int (**x1)(); struct UnknownFieldSet { struct vector<google::protobuf::UnknownField, std::__1::allocator<google::protobuf::UnknownField> > {} *x_2_1_1; } x2; unsigned int x3[1]; int x4; struct UUID {} *x5; struct FunctorArchive {} *x6; struct UUID {} *x7; int x8; }*)arg1 archiver:(id)arg2;
...
- (id)initWithArchive:(const struct GroupColumnArchive { int (**x1)(); struct UnknownFieldSet { struct vector<google::protobuf::UnknownField, std::__1::allocator<google::protobuf::UnknownField> > {} *x_2_1_1; } x2; unsigned int x3[1]; int x4; struct UUID {} *x5; struct FunctorArchive {} *x6; struct UUID {} *x7; int x8; }*)arg1;
