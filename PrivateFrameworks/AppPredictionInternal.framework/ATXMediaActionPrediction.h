...
+ (id)updatePlayMediaActionPredictions:(id)arg1 withUpcomingMedia:(id)arg2 forActionKey:(id)arg3 appActionPredictionItem:(const struct ATXPredictionItem { id x1; float x2[259]; float x3; }*)arg4 appActionLogProbability:(double)arg5 statistics:(id)arg6;
