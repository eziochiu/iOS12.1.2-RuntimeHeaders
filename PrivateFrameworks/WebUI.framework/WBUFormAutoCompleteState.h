...
@interface WBUFormAutoCompleteState : NSObject <CNContactPickerDelegate, WBUContactAutoFillViewControllerFiller, WBUCreditCardCaptureViewControllerDelegate, _ASCredentialProviderExtensionViewControllerDelegate, _ASPasswordCredentialAuthenticationViewControllerDelegate> {
