...
@property (nonatomic) <CAMCameraViewControllerCameraSessionDelegate> *cameraSessionDelegate;
...
@property (getter=creativeCameraDelegate, nonatomic) <CAMCreativeCameraDelegate> *creativeCameraDelegate;
...
- (void)setCameraSessionDelegate:(id)arg1;
