...
- (bool)constrainMonoParams:(int)arg1 atTime:(union { double x1; struct { /* ? */ } *x2; })arg2;
...
- (void)getRed:(double*)arg1 green:(double*)arg2 blue:(double*)arg3 alpha:(double*)arg4 fromParam:(int)arg5 atFxTime:(union { double x1; struct { /* ? */ } *x2; })arg6;
- (id)initWithAPIManager:(id)arg1;
- (bool)monochromeChanged:(union { double x1; struct { /* ? */ } *x2; })arg1;
