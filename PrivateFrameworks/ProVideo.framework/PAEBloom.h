...
- (bool)addParameters;
- (bool)bloomHeliumRender:(id)arg1 withInput:(id)arg2 withRadius:(double)arg3 withBrightness:(double)arg4 withThreshold:(double)arg5 doDarkBloom:(bool)arg6 withXScale:(double)arg7 withYScale:(double)arg8 withDoCrop:(bool)arg9 withDoClip:(bool)arg10 is360:(bool)arg11 withInfo:(struct { union { double x_1_1_1; struct { /* ? */ } *x_1_1_2; } x1; unsigned long long x2; unsigned long long x3; double x4; double x5; unsigned long long x6; })arg12;
